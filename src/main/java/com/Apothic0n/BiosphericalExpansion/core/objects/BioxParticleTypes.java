...
public final class BioxParticleTypes {
    private BioxParticleTypes () {}

    public static final DeferredRegister<ParticleType<?>> PARTICLE_TYPES = DeferredRegister.create(ForgeRegistries.PARTICLE_TYPES, BiosphericalExpansion.MODID);
